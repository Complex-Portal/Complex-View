    ...
    <div id="global-footer" class="grid_24">
        ...
        <nav id="global-nav-expanded">
            <div class="grid_4 alpha">
                <a href="http://www.ebi.ac.uk" title="EMBL-EBI"><img src="//www.ebi.ac.uk/web_guidelines/images/logos/EMBL-EBI/EMBL_EBI_Logo_black.png" alt="EMBL European Bioinformatics Institute"></a>
                <ul>
                    <li class="first"><a href="//www.ebi.ac.uk/about/news">News</a></li>
                    <li><a href="//www.ebi.ac.uk/about/brochures">Brochures</a></li>
