...
//        solrJettyRunner.join(); // keep the server running ...
    ...
    public void testGetByQuery() throws Exception {
        ResponseImpl response = (ResponseImpl) service.getByQuery("imatinib", "psi-mi/tab25", "0", "200");
    ...
    public void testGetByQuery_maxResults() throws Exception {
        ResponseImpl response = (ResponseImpl) service.getByQuery("imatinib", "psi-mi/tab25", "0", "3");
