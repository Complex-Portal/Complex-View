...
<div id="masthead">
  <h1><a href="/"><img src="/img/e-bang.gif" style="width: 46px; height: 40px; vertical-align:bottom; border:0px; padding-bottom:2px" alt="" title="Home" /></a><a href="http://www.derkholm.net/thomas/dazzle/" class="home serif">DAS registration server</a>
...
<div id="help"><strong>
  <a href="/">HOME</a> &#183;
  <a href="/das1/sources">DAS&#160;SOURCES</a> &#183;

  <a href="/help_index.jsp" class="blue-button">HELP</a>
</strong></div>
</xsl:template>
