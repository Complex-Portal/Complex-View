...
public class WebappUtils {
    ...
    public static String encrypt(FacesContext facesContext, String str) throws SearchWebappException {
        return new DesEncrypter(secretKey(facesContext)).encrypt(str);
    }

    public static String decrypt(FacesContext facesContext, String str) throws SearchWebappException {
