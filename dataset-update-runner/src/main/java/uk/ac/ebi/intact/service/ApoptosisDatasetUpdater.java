...
import uk.ac.ebi.intact.dbupdate.dataset.selectors.ApoptosisDatasetSelector;

/**
 * Updater of apoptosis dataset
 *
...
public class ApoptosisDatasetUpdater {
    ...
    public static void main( String[] args ){
        ...
        ApoptosisDatasetSelector selector = null;
        try {
            selector = new ApoptosisDatasetSelector(selectionReport);
