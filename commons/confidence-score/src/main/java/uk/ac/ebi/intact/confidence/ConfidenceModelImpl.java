 ...
 *               </pre>
 */
public class ConfidenceModelImpl {
    /**
     * Sets up a logger for that class.
     */
    public static final Log log = LogFactory.getLog( ConfidenceModelImpl.class );
    ...
    public ConfidenceModelImpl() {
    }

    public ConfidenceModelImpl( String dbFolderPath, String uniprotSwissprotPath, String workDirPath,
...
//        runTadm();
    ...
    public void getConfidenceListsFromDb() {
        IntactDbRetriever intactdb = new IntactDbRetriever( workDir, new SpokeExpansion() );
        long start = System.currentTimeMillis();
