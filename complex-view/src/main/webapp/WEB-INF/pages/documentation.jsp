...
<!-- /local-nav -->
    ...
    <div id="content" role="main" class="grid_24 clearfix">
        ...
        <p><b>Complex systematic name</b> - Derived using the Reactome rules for naming complexes. In principle this is a string of gene names of the participants of the complex separated by a colon (e.g. &quot;fiba:fibb:fibg&quot;). The order is determined by the order of synthesis of the complex. Where several participants join at the same time, or the order is unknown, alphanumeric order is used. Recommended gene names for each model organism will be used; therefore the systematic name may not be consistent when a complex is conserved across a taxonomic range.</p>
        ...
        <p><b>Ligand</b> - when a complex has one or more ligands transiently associated with it, they will be listed under this heading.</p>
