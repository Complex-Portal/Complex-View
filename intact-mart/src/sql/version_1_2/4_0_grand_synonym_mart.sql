...
GRANT SELECT, INSERT, UPDATE, DELETE ON INTACT__COMPONENT_ALIAS__DM TO INTACT_SELECT;
GRANT SELECT, INSERT, UPDATE, DELETE ON INTACT__COMPONENT_ANNO__DM TO INTACT_SELECT;
GRANT SELECT, INSERT, UPDATE, DELETE ON INTACT__COMPONENT_XREF__DM TO INTACT_SELECT;
GRANT SELECT, INSERT, UPDATE, DELETE ON INTACT__COMPONENT__MAIN TO INTACT_SELECT;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON INTACT__PUBLICATION_ALIAS__DM TO INTACT_SELECT;
GRANT SELECT, INSERT, UPDATE, DELETE ON INTACT__PUBLICATION_ANNO__DM TO INTACT_SELECT;
GRANT SELECT, INSERT, UPDATE, DELETE ON INTACT__PUBLICATION_XREF__DM TO INTACT_SELECT;
GRANT SELECT, INSERT, UPDATE, DELETE ON INTACT__PUBLICATION__MAIN TO INTACT_SELECT;
