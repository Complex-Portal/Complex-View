...
RangeStatusFunctionCollection = function(featureDrawer){
    ...
    // change position to 0 for range type combination with n terminal range at the beginning
    ...
    // change position to length of protein for range type combination with c terminal range at the end
