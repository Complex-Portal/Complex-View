...
<% uk.ac.ebi.intact.application.editor.event.EventListener eventListener = uk.ac.ebi.intact.application.editor.event.EventListener.getInstance();
    request.setAttribute(uk.ac.ebi.intact.application.editor.struts.framework.util.EditorConstants.EVENT_LISTENER, eventListener);
%>
<jsp:useBean id="listener" scope="request"
    beanName="listener"
