...
@Lazy
public class DatasetPopulatorImpl extends JpaAwareController implements DatasetPopulator {

    private static final Log log = LogFactory.getLog( DatasetPopulatorImpl.class );

    private List<String> allDatasets;
    private List<SelectItem> allDatasetSelectItems;

    public DatasetPopulatorImpl() {
