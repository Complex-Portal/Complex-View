...
public class ImexWsClientFacade {
     ...
     * @throws ImexFacadeException
     */
    public ImexPublication createPublication( String type,
                                              String pubmedId,
                                              ImexPublicationStatus status,
                                              String title,
                                              String author,
                                              Date releaseDate,
                                              Date expectedPublicationDate,
                                              Date publicationDate,
                                              String loginId
    ) throws ImexFacadeException {
        uk.ac.ebi.imexcentral.wsclient.generated.Publication publication = null;
        try {
            publication = imexClient.createPublication( type, pubmedId, status.getStatusName(), title, author, dateConvertor( releaseDate ),
                                                        dateConvertor( expectedPublicationDate ), dateConvertor( publicationDate ), loginId );
        } catch ( ImexCentralWebserviceException_Exception e ) {
            throw new ImexFacadeException( e );
     ...
     *
     */
    public void updatePublicationStatus( String pubmedId, ImexPublicationStatus status, String loginId )
            throws ImexCentralWebserviceException_Exception {
